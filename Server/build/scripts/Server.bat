...
set CLASSPATH=%APP_HOME%\lib\Server.jar;%APP_HOME%\lib\guava-21.0.jar;%APP_HOME%\lib\vertx-core-3.4.1.jar;%APP_HOME%\lib\vertx-web-3.4.1.jar;%APP_HOME%\lib\vertx-web-client-3.4.1.jar;%APP_HOME%\lib\netty-common-4.1.8.Final.jar;%APP_HOME%\lib\netty-buffer-4.1.8.Final.jar;%APP_HOME%\lib\netty-transport-4.1.8.Final.jar;%APP_HOME%\lib\netty-handler-4.1.8.Final.jar;%APP_HOME%\lib\netty-handler-proxy-4.1.8.Final.jar;%APP_HOME%\lib\netty-codec-http-4.1.8.Final.jar;%APP_HOME%\lib\netty-codec-http2-4.1.8.Final.jar;%APP_HOME%\lib\netty-resolver-4.1.8.Final.jar;%APP_HOME%\lib\netty-resolver-dns-4.1.8.Final.jar;%APP_HOME%\lib\jackson-core-2.7.4.jar;%APP_HOME%\lib\jackson-databind-2.7.4.jar;%APP_HOME%\lib\vertx-auth-common-3.4.1.jar;%APP_HOME%\lib\vertx-web-common-3.4.1.jar;%APP_HOME%\lib\netty-codec-4.1.8.Final.jar;%APP_HOME%\lib\netty-codec-socks-4.1.8.Final.jar;%APP_HOME%\lib\netty-codec-dns-4.1.8.Final.jar;%APP_HOME%\lib\jackson-annotations-2.7.0.jar

@rem Execute Server
"%JAVA_EXE%" %DEFAULT_JVM_OPTS% %JAVA_OPTS% %SERVER_OPTS%  -classpath "%CLASSPATH%" App %CMD_LINE_ARGS%
